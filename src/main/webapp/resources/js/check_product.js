...
function productUpdateCheck(){
	var nameInput = document.productUpdateForm.p_name;
	var photoInput = document.productUpdateForm.p_photo;
	var priceInput = document.productUpdateForm.p_price;
	var brandInput = document.productUpdateForm.p_brand;
	var quantityInput = document.productUpdateForm.p_quantity;
	var contentInput = document.productUpdateForm.p_content;
...
function productUpdateFashionCheck(){
	var nameInput = document.productUpdateForm.p_name;
	var photoInput = document.productUpdateForm.p_photo;
	var priceInput = document.productUpdateForm.p_price;
	var brandInput = document.productUpdateForm.p_brand;
	var quantityInput = document.productUpdateForm.p_quantity;
	var contentInput = document.productUpdateForm.p_content;
	var colorInput = document.productUpdateForm.d_color;

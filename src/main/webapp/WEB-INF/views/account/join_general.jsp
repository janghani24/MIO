...
<body>
	...
	<form action="account.join"
		...
		<table id="joinTable">
			...
			<tr>
				<td class="td1">가입유형</td>
				<td class="td2">
				<input type="radio" name="a_grade" value="general">일반 회원
				<input type="radio" name="a_grade" value="seller">판매자
				</td>
			</tr>
			<tr>
				<td class="td1">ID</td>
				<td class="td2">
				<input id="jm_idInput" name="a_id" placeholder="필수, 영어/숫자로만 입력해주세요." maxlength="10" autocomplete="off" autofocus="autofocus">
				<button onclick="IdCheck()"></button>
				</td>
			</tr>
			<tr>
				<td class="td1">PW</td>
